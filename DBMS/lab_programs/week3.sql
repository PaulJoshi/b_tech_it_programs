...
ALTER TABLE EMPLOYEE DROP CONSTRAINT JOB;

SELECT constraint_name FROM all_constraints WHERE TABLE_NAME = 'EMPLOYEE';


INSERT INTO EMPLOYEE (EMPID, EMPNAME, JOB, MANAGER, DEPTNO, HIRDATE, COMMISSION) VALUES ('E0008', 'GARY', 'TESTER', 'E0004', 'D004', '15-DEC-12', 500);